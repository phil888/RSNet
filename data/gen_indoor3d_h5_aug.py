...
# Set paths
data_label_files = [f for f in os.listdir("/home/phil/PycharmProjects/RSNet/data/stanford_indoor3d") if os.path.isfile(os.path.join("/home/phil/PycharmProjects/RSNet/data/stanford_indoor3d", f))]
...
for file in data_label_files:
    ...
    if split == 'train' and not is_test:
        split_list.append("stanford_indoor3d/" + file )
